...
use super::{transfer_batch::{transfer_batch_is_ended, BatchTransfer}, super::{StateChainEntity, Result}};
...
pub trait Utilities {
    ...
    fn get_statechain(&self, db_read: DatabaseR, state_chain_id: String) -> Result<StateChainDataAPI>;
    ...
    /// API: Get root of sparse merkle tree. Will be via Mainstay in the future.
    fn get_confirmed_smt_root(&self, db_read: DatabaseR, db_write: DatabaseW) -> Result<Option<Root>>;
    ...
    fn get_transfer_batch_status(&self, db_read: DatabaseR, db_write: DatabaseW, batch_id: String) -> Result<TransferBatchDataAPI>;
