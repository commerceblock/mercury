...
pub trait Deposit {
    ...
    fn deposit_init(&self,
        db_write: DatabaseW,
        deposit_msg1: DepositMsg1
    ) -> Result<Uuid>;
...
impl Deposit for StateChainEntity {
    ...
    fn deposit_confirm(
        ...
        verify_tx_confirmed(&tx_backup.input[0].previous_output.txid.to_string(), self)?;
...
pub fn verify_tx_confirmed(txid: &String, sc_entity: &StateChainEntity) -> Result<()> {
